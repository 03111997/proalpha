...
?>
	...
	<div class="login">
  <h1 style='color:#005086;'>create a new location :</h1>
    <form action="gestion" method="post">
      <input type="text" id="nom" name="nom" placeholder="name"  value='<?= $nom ?>' required="required" />
	...
	<pre><?php include( "model/Action.php" ); ?></pre>
<?php include( "vue/HTMLEnd.php" ); ?>

<div style='background-color:#929292'>
		<caption style='text-align: left;'><a href='deconexion?lapsTime=0' style="font-size:20px;" class="btn btn-primary btn-block btn-large">Disconnect</a></caption>
</div>
	<br/>
